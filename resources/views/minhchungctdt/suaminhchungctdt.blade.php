                ...
                <form method="post" action="" name="editForm" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="f-grid">
                            <div class="form-group f-grid-col">
                                ...
                                <div class="control-group">
                                    <input type="number" value="{{ $minhchung->sohieu }}" name="sohieu"
                                        data-form-field="number" placeholder="Chọn số" class="span8" min="1">
                                </div>
                            </div>
                            <div class="form-group f-grid-col">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tenminhchung"
                                value="{{ $minhchung->tenminhchung }}" placeholder="Tên minh chứng">
                        </div>
                        <div class="form-group">
                            <label>Nơi ban hành</label>
                            <input type="text" class="form-control" name="noibanhanh" value="{{ $minhchung->noibanhanh }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control noidung" rows="3" name="noidung" value="{{ $minhchung->noidung }}"
                                placeholder="Nhập nội dung ...">{{ $minhchung->noidung }}</textarea>
                        </div>
                        <div class="form-group">
