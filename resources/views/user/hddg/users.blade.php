                ...
                <tr id="row_{{$item->id}}" data-address = "{{$item->address}}" data-phone = "{{$item->phone}}">
                    ...
                    <td>
                        <div class="text-center">
                            <button class="btn btn-primary" onclick="editFunc({{$item->id}})"> <i
        ...
        success: function(data) {
          // console.log(data[0]);
                ...
                let newRow = table.row.add([
                    ...
                    `${data.email}`,
                    `${data.permission}`,
                    '<a href="javascript:void(0)" class="btn btn-primary" onclick="editFun(' + data.id + ')"><i class="bi bi-pencil-square"></i></a>' +
                    '<a href="javascript:void(0)" class="btn btn-danger" onclick="deleteFun(' + data.id + ')"><i class="bi bi-trash3"></i></a>'
                ]).draw(false).node();
        ...
        error: function(data) {
            ...
            // if (data.status == 422) {
                ...
                if (errors.password_confirmation) {
                    $("#error_password_confirm").text(errors.password_confirmation[0]);
                }
            // }
        }
    });
